#This script should allow you to visualize the radar data
#Run the radar code and then run this script
import serial
import time
...
#You will need to change the serial port to correspond to your connected board
